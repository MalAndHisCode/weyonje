...
| Light and dark design tokens | **Partially Implemented** | Generated Forui colour, typography, icon, and style definitions exist, including green primary colours and touch-oriented variants. They are not usable while the theme library declarations are broken. | `apps/mobile/lib/theme/` |
